!(function (i, t) {
  ...
  function h(i, t, r, s, h, a) {
    var e = (s - t) * (h - i),
      n = (r - i) * (a - t);
    return Math.abs(e - n) >= 33306690738754716e-32 * Math.abs(e + n)
      ? e - n
      : 0;
  }
  function a(i, t, r, s, a, e) {
    return (
      (h(a, e, i, t, r, s) || h(i, t, r, s, a, e) || h(r, s, a, e, i, t)) < 0
    );
  }
  ...
  function n(i, t, r, s) {
    if (s - r <= 20)
      for (var h = r + 1; h <= s; h++) {
        for (var a = i[h], e = t[a], o = h - 1; o >= r && t[i[o]] > e; )
          i[o + 1] = i[o--];
        i[o + 1] = a;
      }
    else {
      ...
      (i[r + 1] = i[_]),
        (i[_] = d),
        s - f + 1 >= _ - r
          ? (n(i, t, f, s), n(i, t, r, _ - 1))
          : (n(i, t, r, _ - 1), n(i, t, f, s));
    }
  }
  function l(i, t, r) {
    var s = i[t];
  ...
  return (
    ...
    (r.prototype.update = function () {
      ...
      for (
        var w, p, b, A = (_ + v) / 2, k = (d + u) / 2, x = 1 / 0, M = 0;
        M < f;
        M++
      ) {
      ...
      for (var R = 0; R < f; R++)
        this._dists[R] = s(t[2 * R], t[2 * R + 1], Q.x, Q.y);
      ...
      for (var W = 0, X = void 0, Y = void 0; W < this._ids.length; W++) {
        ...
        if (
          ...
          for (
            ...
            ri < this._hashSize &&
            (-1 === (ti = o[(si + ri) % this._hashSize]) || ti === h[ti]);
            ri++
          );
          for (
            var hi = (ti = r[ti]), ai = void 0;
            (ai = h[hi]),
              !a($, ii, t[2 * hi], t[2 * hi + 1], t[2 * ai], t[2 * ai + 1]);
          ...
          if (-1 !== hi) {
            ...
            for (
              var ni = h[hi];
              (ai = h[ni]),
                a($, ii, t[2 * ni], t[2 * ni + 1], t[2 * ai], t[2 * ai + 1]);
      ...
      for (var li = 0, oi = this._hullStart; li < V; li++)
        (this.hull[li] = oi), (oi = h[oi]);
